/**
 * name：Endless_Google.user.js
 * url：https://openuserjs.org/install/tumpio/Endless_Google.user.js
 * 
 * Make：Endless google
 *
 ******** The following is the rewrite information automatically generated by tamperJS, which may need to be adjusted according to the situation ********
...
document.addEventListener("DOMContentLoaded", init);
  ...
  console.log('Add to tamperJS：Endless_Google.user.js')
}
